        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card mb-3" style="width: 200px; height: 400px">
                    <img src=<?php echo e($post->image); ?> class="card-img-top" alt="..." style="width: 200px; height: 100%;">
                    <div style="height:700px">
                        <h6 class="card-title"><a href=<?php echo e($post->link); ?>><?php echo e($post->title); ?></a></h6>
                        <p style="font-size:12px"><?php echo e($post->description); ?></p>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\int\resources\views/post.blade.php ENDPATH**/ ?>